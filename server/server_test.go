...
func TestServerBoundHandler(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			wantInbounds: []remote.InboundHandler{
				bound.NewServerLimiterHandler(&limiterMocks.ConcurrencyLimiter{}, &limiter.DummyRateLimiter{}, nil),
		...
		},
		{
			...
			wantInbounds: []remote.InboundHandler{
				bound.NewServerLimiterHandler(&limiterMocks.ConcurrencyLimiter{}, limiter.NewQPSLimiter(interval, 10000), nil),
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
			},
			wantOutbounds: []remote.OutboundHandler{
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
		...
		},
		{
			...
			wantInbounds: []remote.InboundHandler{
				bound.NewServerMuxLimiterHandler(&limiterMocks.ConcurrencyLimiter{}, &limiterMocks.RateLimiter{}, nil),
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
			},
			wantOutbounds: []remote.OutboundHandler{
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
		...
		},
		{
			...
			wantInbounds: []remote.InboundHandler{
				bound.NewServerMuxLimiterHandler(limiter.NewConcurrencyLimiter(1000), limiter.NewQPSLimiter(interval, 10000), nil),
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
			},
			wantOutbounds: []remote.OutboundHandler{
				bound.NewTransMetaHandler([]remote.MetaHandler{transmeta.MetainfoServerHandler}),
...
func (*mockRateLimiter) Acquire() bool                                      { return true }
func (*mockRateLimiter) Status() (max, current int, interval time.Duration) { return }
