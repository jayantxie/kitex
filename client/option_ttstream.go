...
func WithTTHeaderStreamingTransportOptions(opts ...ttstream.ClientHandlerOption) TTHeaderStreamingOption {
	return TTHeaderStreamingOption{F: func(o *remote.ClientTTHeaderStreamingOptions, di *utils.Slice) {
